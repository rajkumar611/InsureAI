...
REGULATIONS = [
    ...
    },
    {
        ...
        "rule_description": "Insurer must disclose natural hazard exclusions clearly in policy wording.",
        "rule_data": {
    ...
    },
    {
        ...
        "rule_description": "EQC levy must be collected for all residential property policies in NZ.",
        "rule_data": {
    ...
    },
    {
        ...
        "rule_description": "High-value residential policies above NZD 5M require senior underwriter sign-off.",
        "rule_data": {
            "requirement": "high_value_approval",
